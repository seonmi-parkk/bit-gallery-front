type OrderDetailItemComponentProps = {
  orderItem: OrderPreviewDto;
  setIsOpenModal: (value: boolean) => void;
  setSelectedPno: (value: number) => void;
};

const OrderDetailItemComponent = ({orderItem, setIsOpenModal, setSelectedPno}:OrderDetailItemComponentProps) => {
  ...
  return (
    <li 
      key={pno} 
      className={`border-t border-main-4 cart-item`}
    >
...
export default OrderDetailItemComponent
